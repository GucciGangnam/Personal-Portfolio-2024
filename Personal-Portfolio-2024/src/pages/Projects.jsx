            ...
            <div className="Main">
                ...
                <div className="Project-container">
                    ...
                    <div className="Project-description">
                        Kiko is a full stack events based mobile web app that uses our phones to bring people together in real life. Post what your up to, choose who can join and let the 6 degrees of seperation work its magic! Try it out!
                ...
                <div className="Project-container-reverse">
                    ...
                    <div className="Project-description">
                        Moment is an Group focused instant messaging application that aims to replicate the dynamics of face to face snap conversations. Messages dissapear after a few seconds and say 'goodbye' to endless catch up scrolling. This was another full MERN stack application that allowed me to explore and implement new technologies.
                        <div className="Project-Technology">
                            <img
                                className="Project-tech-icon"
                                src="/JavaScript.png"
                ...
                <div className="Project-container">
                    ...
                    <div className="Project-description">
                        Toon Finder is a full MERN stack game where users try to find and tag cartoon characters in a picture as quick as possible.  This project pulled upon a wide range of Javescript knowledge to complete and was one of three final full stack projects set by the Odin Project.
                        <div className="Project-Technology">
                            <img
                                className="Project-tech-icon"
                                src="/JavaScript.png"
                ...
                <div className="Project-container-reverse">
                    ...
                    <div className="Project-description">
                        Console.blog is a developer focused blog posting site where users can blog and converse in comment sections. This project showcases the implementation of a full JAM stack with a focus on restful API developemnt and access tokens.
                        <div className="Project-Technology">
                            <img
                                className="Project-tech-icon"
                                src="/JavaScript.png"
